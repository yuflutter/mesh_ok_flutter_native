...
- Непонятно, что делать, если третье устройство пытается подключиться к пиру, который уже входит в группу в качестве клиента (если целевой пир является хостом - подключение успешно проходит).
